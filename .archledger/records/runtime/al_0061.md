...
- Assembly Layer
- Converter Layer
trigger: User invokes archledger build with optional --format, --formats, --all, or
  --output
result: Assembled architecture document in the requested format(s) written to the
  build directory.
source_refs:
- archledger/cli.py
